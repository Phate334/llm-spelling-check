...
class VllmClient:
    def __init__(self, base_url: str, model: str, api_key: str | None = None, timeout: float = 30.0) -> None:
    ...
    def score_prompt(self, text: str, prompt_logprobs: int) -> dict[str, Any]:
        ...
        request = Request(f"{self.base_url}/completions", data=body, headers=headers, method="POST")
        try:
